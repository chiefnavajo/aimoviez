      ...
      <div className="hidden md:flex h-screen">
        ...
        <div className="w-56 h-full flex flex-col py-4 px-3 border-r border-white/10">
          ...
          <nav className="flex-1 space-y-1">
            ...
            <Link href="/leaderboard"><div className="flex items-center gap-3 px-3 py-3 rounded-lg bg-white/10 text-white border border-white/10"><Trophy className="w-6 h-6 text-yellow-500" /><span className="font-semibold">Leaderboard</span></div></Link>
