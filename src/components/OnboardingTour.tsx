...
const TOUR_STEPS: TourStep[] = [
  ...
  },
  {
    ...
    description: 'Swipe through clips and tap the ∞ button to vote. You have 200 votes per day - use them to help your favorite clips win their slot!',
  ...
  },
  {
    ...
    description: 'See how all the winning clips come together to form an amazing 10-minute collaborative movie!',
  ...
  },
  {
    ...
    description: 'Upload your own 8-second clips and compete for a slot. Get your clip in the final movie!',
